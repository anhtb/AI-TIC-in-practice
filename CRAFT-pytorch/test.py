...
parser.add_argument('--canvas_size', default=490, type=int, help='image size for inference')
parser.add_argument('--mag_ratio', default=1.8, type=float, help='image magnification ratio')
parser.add_argument('--poly', default=False, action='store_true', help='enable polygon type')
parser.add_argument('--show_time', default=False, action='store_true', help='show processing time')
...
parser.add_argument('--refiner_model', default='models/craft_refiner_CTW1500.pth', type=str, help='pretrained refiner model')
